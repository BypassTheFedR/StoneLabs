      ...
      if (scnr.hasNextInt()) {
	   ...
	   /**NESTED BRANCH:
          ...
          if (numberCups >= MIN_CUPS && numberCups <= MAX_CUPS) {
            ...
            System.out.println(numberCups + " is a not a valid number of cups!");
            System.out.println("Please enter the number of cups (between 1 and 100): ");
            numberCups = scnr.nextInt();
            ...
            if (numberCups >= MIN_CUPS && numberCups <= MAX_CUPS) {
              ...
              System.out.println(numberCups + " is a not a valid number of cups! Sorry you are out of attempts.");
              }
            }
          } else {
